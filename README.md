...
An optional dependency is _docutils_, which allow to render reStructuredText docstrings.
...
- _rst_ an example using resTructuredText docstrings (requires doctutils installed)
